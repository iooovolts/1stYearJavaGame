 ...
 */
public class ListenerCoin implements CollisionListener {
     ...
     */
    public ListenerCoin(Dragon drake) {
        this.drake = drake;
    }

    /**
     * This method enables dragon to pick up coins with sound effects
    ...
    public void collide(CollisionEvent e) {
        if (e.getOtherBody() == drake) {
            ...
            try {
                gameMusic = new SoundClip("data/coinpickup.mp3");
                gameMusic.play();
